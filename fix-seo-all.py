...
DESCRIPTIONS = {
    ...
    'acid': 'Acid - gradien neon ekstrem, blur glow menyala, bentuk cair, dan tipografi besar dengan warna acid-psych.',
    'dark_minimal': 'Dark Mode Minimal - antarmuka gelap bersih: latar near-black, satu warna aksen, tipografi ringan, dan fokus penuh pada konten.',
    'editorial': 'Editorial - layout majalah: grid ketat, headline serif besar, hierarki tipografi, dan whitespace elegan ala publikasi premium.',
    'material_design': 'Material Design - bahasa desain Google: elevation shadow, kartu, warna primary-bold, dan komponen berprinsip material fisik.',
    'neo_brutalism': 'Neo-Brutalism - border hitam tebal, hard shadow tanpa blur, warna mencolok, dan kesan mentah yang berani ala trend desain modern.',
    'solarpunk': 'Solarpunk - masa depan hijau cerah: panel surya, taman vertikal, energi terbarukan, dan optimisme regeneratif.',
    'cottagecore': 'Cottagecore - romansa pedesaan: motif bunga, warna krem pastel, tekstur tenun, dan kehidupan desa yang tenang dan hangat.',
    'dark_academia': 'Dark Academia - romansa keilmuan klasik: cokelat tua, parchment, tipografi serif antik, dan suasana perpustakaan Eropa.',
    'holographic': 'Holographic - kilau iridescent pelangi di atas permukaan kaca, gradien shimmer bergerak, dan kesan futuristic premium.',
    'scandinavian': 'Scandinavian - hygge dan minimalisme Nordik: putih hangat, kayu terang, ruang lapang, dan kesederhanaan yang menenangkan.',
    'steampunk': 'Steampunk - Victoria bertemu mesin uap: kuningan, tembaga, gerigi berputar, parchment, dan detail industri abad ke-19.',
    'web20': 'Web 2.0 - nostalgia mid-2000s: tombol glossy, rounded corner, gradien biru-putih, refleksi kaca, dan estetika social media awal.',
    'fairycore': 'Fairycore - dunia peri yang whimsical: pastel lavender-pink, sparkle bintang, hutan ajaib, dan kelembutan dongeng.',
    'grandmacore': 'Grandmacore - kehangatan rumah nenek: doily renda, wallpaper bunga, rajutan crochet, teh sore, dan keramahan vintage.',
    'japandi': 'Japandi - perpaduan Jepang dan Skandinavia: wabi-sabi, kayu hangat, warna tanah netral, dan ketenangan yang harmonis.',
    'noir': 'Film Noir - hitam-putih dramatis ala detektif 1940-an: bayangan tajam, garis venetian blind, tipografi serif tegas, dan suasana misteri.',
    'retro_futurism': 'Retro Futurism - Atomic Age 1950-an: bentuk starburst, roket, warna mustard-teal, dan optimisme masa depan masa lalu.',
    'vhs_glitch': 'VHS Glitch - estetika kaset video analog: scanline, chromatic aberration RGB, noise, dan distorsi tape yang rusak.',
